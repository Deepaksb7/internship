            ...
            <div className="relative flex h-auto w-full max-w-lg flex-col bg-white overflow-hidden rounded-xl shadow-lg ">
                <div className="p-8 flex flex-col items-center gap-6">
                    ...
                    <div className="bg-gray-200 rounded-full p-4">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#4CAF50" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-circle-check-icon lucide-circle-check"><circle cx="12" cy="12" r="10" /><path d="m9 12 2 2 4-4" /></svg>
                    </div>
